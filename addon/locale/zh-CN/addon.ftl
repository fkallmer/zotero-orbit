...
graph-axes-note = Mark size is how many works each one cites. Arrows point from the citing work to the cited one. Scroll to zoom, drag to pan; hold Shift to stretch the horizontal axis alone, Alt for the vertical.
graph-axis-x = Across
graph-axis-y = Up
